...
/*-------------------------------------------------------------------------*/ /**
  See "mss_rtc.h" for details of how to use this function.
 */
void MSS_RTC_set_calendar_count(
 ...
 * See "mss_rtc.h" for details of how to use this function.
 */
void MSS_RTC_get_calendar_count(
